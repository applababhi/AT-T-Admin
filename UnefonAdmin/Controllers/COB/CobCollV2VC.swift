...
class CobCollV2VC: UIViewController {
...
extension CobCollV2VC : UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout
{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell:CobCollV2Cell = collView.dequeueReusableCell(withReuseIdentifier: "CobCollV2Cell", for: indexPath) as! CobCollV2Cell

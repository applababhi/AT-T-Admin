//
//  Report_DoubleBarChartMensual.swift
//  UnefonAdmin
//
...
class Report_DoubleBarChartMensual: UIViewController {
    ...
    func setupTF()
    {
        ...
        txtFld.setPlaceHolderColorWith(strPH: "2019")
...
extension Report_DoubleBarChartMensual: UITextFieldDelegate
{
...
extension Report_DoubleBarChartMensual: UIPickerViewDelegate, UIPickerViewDataSource
{
    func showPickerView()
    {
        // UIPickerView
    ...
    func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int) -> String? {
        let dict:String = arr_Picker[row]
...
extension Report_DoubleBarChartMensual : UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout
{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let str:String = dict["year_str"] as? String
        {
...
extension Report_DoubleBarChartMensual
{
    func callGetValues()
    {        
        self.showSpinnerWith(title: "Cargando...")
        let param: [String:Any] = ["plan_id":plan_id, "uuid":uuid, "year":strPicker]
        WebService.requestService(url: ServiceName.GET_INSDetail_DoubleBar_Monthly.rawValue, method: .get, parameters: param, headers: [:], encoding: "URL", viewController: self) { (json:[String:Any], jsonString:String, error:Error?) in
            self.hideSpinner()
             //   print(jsonString)
